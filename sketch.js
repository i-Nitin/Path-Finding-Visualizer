...
function dropdown(event) {
    ...
    let message = document.getElementById('message')
    if(algo === "A* Search"){
        message.innerHTML = `<span style = "font-weight: bold;">A* Search</span>`
    }
    else if(algo === "Dijkstra"){
        message.innerHTML = `<span style = "font-weight: bold;">Dijkstra's Algorithm</span>`
    }
    else if(algo === "Breadth First Search"){
        message.innerHTML = `<span style = "font-weight: bold;">Breadth First Search (BFS)</span>`
    }
}
